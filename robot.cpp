...
// }
void Robot::Home(){
    writeSerialPort("home\n");
}

void Robot::khongGianKhop(float q1, float q2, float q3, float q4,double* curAngle,double *curPosition)
{
//     q2=90-q2;
//     q3=-(105+q2-q3);
...
void Robot::khongGianThaoTac(float a, float b, float c, QObject* curAngle, QObject* curPosition)
{
    ...
    qDebug()<<(round((90 - q2 * 180 /  3.14) * 100.0) / 100.0);
