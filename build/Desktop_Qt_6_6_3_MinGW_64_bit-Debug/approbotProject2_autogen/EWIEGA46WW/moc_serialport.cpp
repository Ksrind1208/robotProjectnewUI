...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSerialPortENDCLASS_t qt_meta_stringdata_CLASSSerialPortENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 17),  // "writeToSerialPort"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 4),  // "data"
        QT_MOC_LITERAL(35, 18),  // "readFromSerialPort"
        QT_MOC_LITERAL(54, 15)   // "closeSerialPort"
    },
    "SerialPort",
    "writeToSerialPort",
    "",
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->writeToSerialPort((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->readFromSerialPort(); break;
